...
const presets = { Aura, Lara, Nora, Material } as const;

declare type KeyOfType<T> = keyof T extends infer U ? U : never;

declare type SurfacesType = { name?: string; palette?: { 0?: string; 50?: string; 100?: string; 200?: string; 300?: string; 400?: string; 500?: string; 600?: string; 700?: string; 800?: string; 900?: string; 950?: string } };

@Component({
    selector: 'app-mini-configurator',
    standalone: true,
    imports: [CommonModule, FormsModule, SelectButtonModule],
    template: `
        <div class="p-2 gap-4 flex flex-wrap justify-center">
...
export class AppMiniConfigurator {
