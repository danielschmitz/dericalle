    ...
    template: `
        <div id="highlights" class="py-6 px-6 lg:px-20 mx-0 my-12 lg:mx-20">
            <div class="text-center">
                <div class="text-surface-900 dark:text-surface-0 font-normal mb-2 text-4xl">Marketing Digital Integrado</div>
                <span class="text-muted-color text-2xl">Estratégias completas para seu negócio...</span>
            </div>
            ...
            <div class="grid grid-cols-12 gap-4 mt-20 pb-2 md:pb-20">
                ...
                <div class="col-span-12 lg:col-span-6 my-auto flex flex-col lg:items-end text-center lg:text-right gap-4">
                    ...
                    <div class="leading-none text-surface-900 dark:text-surface-0 text-3xl font-normal">Mobile First</div>
                    <span class="text-surface-700 dark:text-surface-100 text-2xl leading-normal ml-0 md:ml-2" style="max-width: 650px"
                        >Desenvolvemos estratégias otimizadas para dispositivos móveis. Com mais de 60% do tráfego web vindo de smartphones, garantimos que sua marca tenha impacto onde seus clientes estão navegando.</span
                    >
                </div>
            </div>
            ...
            <div class="grid grid-cols-12 gap-4 my-20 pt-2 md:pt-20">
                <div class="col-span-12 lg:col-span-6 my-auto flex flex-col text-center lg:text-left lg:items-start gap-4">
                    ...
                    <div class="leading-none text-surface-900 dark:text-surface-0 text-3xl font-normal">Análises em Tempo Real</div>
                    <span class="text-surface-700 dark:text-surface-100 text-2xl leading-normal mr-0 md:mr-2" style="max-width: 650px"
                        >Acompanhe o desempenho de suas campanhas em tempo real. Nosso dashboard interativo permite visualizar métricas de conversão, engajamento e ROI, possibilitando ajustes estratégicos imediatos para maximizar resultados.</span
                    >
                </div>
            ...
            <div class="grid grid-cols-12 gap-4 mt-20 pb-2 md:pb-20">
                ...
                <div class="col-span-12 lg:col-span-6 my-auto flex flex-col lg:items-end text-center lg:text-right gap-4">
                    <div class="flex items-center justify-center bg-blue-200 self-center lg:self-end" style="width: 4.2rem; height: 4.2rem; border-radius: 10px">
                        <i class="pi pi-fw pi-cog !text-4xl text-blue-700"></i>
                    </div>
                    <div class="leading-none text-surface-900 dark:text-surface-0 text-3xl font-normal">Automação de Marketing</div>
                    <span class="text-surface-700 dark:text-surface-100 text-2xl leading-normal ml-0 md:ml-2" style="max-width: 650px"
                        >
                        Potencialize seus resultados com automação inteligente. Nossa plataforma permite criar fluxos de nutrição de leads, campanhas de email marketing sequenciais e interações personalizadas, aumentando a eficiência e o engajamento com sua marca.
                        </span
                    >
                </div>
            </div>
